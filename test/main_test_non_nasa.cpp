...
void test_target()
{
    ...
    target.assert_values("00", true, 24.000000, 24.000000, 0, Mode::Cool, FanMode::Hight);

    test_process_data("32c8dec70101000000000000d134");
    test_process_data("32c8f0860100000000000008b734");
    test_process_data("32c8add1ff000000000000004b34");
    test_process_data("32c8008f00000000000000004734");
    test_process_data("3200c8210300000600000000ec34");
    test_process_data("32c8dec70101000000000000d134");
    test_process_data("32c8f0860100000000000008b734");
    test_process_data("32c8add1ff000000000000004b34");
    test_process_data("32c800c0080000004b004d4b4d34");
    test_process_data("3200c82f00f0010b010201051a34");
    test_process_data("32c8dec70101000000000000d134");
    test_process_data("32c8f0860100000000000008b734");
    test_process_data("3200c84020000000408900402134");
    test_process_data("3200c8204d51500001100051e434");
